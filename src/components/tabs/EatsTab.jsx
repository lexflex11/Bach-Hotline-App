...
const RESTAURANTS = {
  ...
  portaransas: [
    {
      id:"porta-1", name:"Seafood & Spaghetti Works", cuisine:"Seafood & Italian", priceRange:"$$",
      vibe:"Waterfront · Casual · Local Favorite",
      rating:4.6, reviews:1240, groupMin:2, groupMax:40,
      tags:["Seafood","Waterfront","Group Friendly","Local Fave"],
      ...
      address:"710 Alister St, Port Aransas, TX 78373",
      desc:"A Port Aransas institution since 1981, Seafood & Spaghetti Works is the go-to spot for fresh Gulf seafood and loaded pasta dishes. The waterfront views, generous portions, and laid-back island vibe make it a perfect group dinner stop.",
      menuHighlights:["Gulf Shrimp Platter","Stuffed Flounder","Crab Legs","Seafood Pasta","Frozen Margaritas"],
      whyWeLoveIt:["A true Port A landmark beloved by locals and visitors alike","Large portions perfect for sharing with your bach crew","Waterfront patio for breezy island dining"],
      reserveUrl:"https://www.seafoodandspaghetti.com",
    },
    {
      id:"porta-2", name:"Fins Bar & Grill", cuisine:"Coastal American", priceRange:"$$",
      vibe:"Beachside · Tropical · Cocktails",
      rating:4.5, reviews:876, groupMin:2, groupMax:30,
      tags:["Beachside","Cocktails","Tropical","Brunch"],
      image:"https://images.unsplash.com/photo-1551024601-bec78aea704b?w=800&q=80",
      images:[
        "https://images.unsplash.com/photo-1551024601-bec78aea704b?w=800&q=80",
        "https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?w=800&q=80",
      ...
      hours:"Daily 11am–10pm",
      address:"322 Beach Access Rd 1A, Port Aransas, TX 78373",
      desc:"Fins brings the tropical beach bar energy your bachelorette crew deserves. Sip on frozen cocktails, dig into fresh Gulf seafood, and soak up the salty air right off the beach. The vibe is festive, fun, and totally island-girl approved.",
      menuHighlights:["Fish Tacos","Gulf Shrimp Ceviche","Fins Nachos","Frozen Piña Coladas","Mango Margaritas"],
      whyWeLoveIt:["Beachside location: sand, sun, and sips all in one","Tropical frozen cocktails perfect for the bachelorette crew","Laid-back energy that matches Port A's island vibe"],
      reserveUrl:"https://www.opentable.com",
    },
    {
      id:"porta-3", name:"Trout Street Bar & Grill", cuisine:"Seafood & American", priceRange:"$$",
      vibe:"Bayfront · Sunset Views · Happy Hour",
      rating:4.7, reviews:654, groupMin:2, groupMax:50,
      tags:["Bayfront","Sunset","Happy Hour","Seafood"],
      image:"https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80",
      images:[
        "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80",
        "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80",
      ...
      desc:"Perched right on the bay, Trout Street is Port Aransas' prime spot for sunset cocktails and fresh-caught Gulf seafood. The sprawling waterfront deck and lively happy hour make it a must for any bachelorette weekend.",
      menuHighlights:["Grilled Red Snapper","Fried Oysters","Gulf Shrimp Boil","Sunset Margaritas","Hush Puppies"],
      whyWeLoveIt:["Stunning bay sunset views from the waterfront deck","Happy hour deals perfect for pre-dinner bach drinks","Massive deck easily fits large bachelorette groups"],
      reserveUrl:"https://www.troutstreetbarandgrill.com",
    },
  ],
};
...
export default function EatsTab({ groupSize: initialGroupSize }) {
  ...
  return (
    <div>
      ...
      <div style={{ ...C, marginBottom:12, display:"flex", flexWrap:"wrap", gap:10 }}>
