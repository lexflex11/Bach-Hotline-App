...
const GARLAND_3D_LAYOUT = [
  // ── SPINE — large anchors, tight diagonal lower-left to upper-right ───────
  [-3.2, -0.8,  0.0, 1.00, 0],
  [-1.5,  0.0,  0.1, 1.05, 1],
  [ 0.2,  0.7, -0.1, 1.05, 2],
  [ 1.9,  1.1,  0.1, 1.00, 3],
...
const GARLAND_X_MIN = -4.8;
const GARLAND_X_MAX = 5.2;
  ...
  return (
    <div style={{borderRadius:14,overflow:"hidden",border:`1.5px solid ${BORDER}`,background:bg}}>
      <div style={{height:260,background:bg}}>
        <Canvas camera={{ position:[0.5, 3.5, 11], fov:55 }} style={{background:bg}}>
